...
async function main() {
  ...
  await prisma.product.create({
    data: {
      ...
      sku: 'KAS-COAT-001',
      tags: JSON.stringify(['Winter', 'Hand-embroidered', 'GI Tagged', 'Luxury']),
  ...
  await prisma.product.create({
    data: {
      ...
      description: 'The Terracotta Banarasi Silk Saree is part of the IDFIS Banarasi Heritage Collection, curated to celebrate the luminous silk of Varanasi. Designed for modern global wardrobes, this piece reflects the beauty of Indian craftsmanship through its rich terracotta hue and pure zari brocade work.',
      price: 65000,
      ...
      material: 'Pure Katan Silk with Metallic Zari',
      ...
      sku: 'BAN-SAR-001',
      tags: JSON.stringify(['Wedding', 'Heritage', 'GI Tagged', 'Silk']),
  ...
  await prisma.product.create({
    data: {
      ...
      dispatchType: 'Ready to Ship',
      sku: 'CHI-KUR-001',
      tags: JSON.stringify(['Summer', 'Hand-embroidered', 'GI Tagged', 'Minimalist']),
      variants: {
        create: [
          { name: 'Size: S', type: 'Size', value: 'S' },
          { name: 'Size: M', type: 'Size', value: 'M' },
  ...
  await prisma.product.create({
    data: {
      ...
      description: 'The Indigo Ajrakh Stole is part of the IDFIS Block Print Collection, curated to celebrate natural dyes. This piece reflects the beauty of Indian craftsmanship through a 16-step hand block printing process.',
      price: 12000,
      ...
      material: 'Modal Silk',
      technique: 'Natural Dye Ajrakh Block Print',
  ...
  await prisma.product.create({
    data: {
      ...
      material: 'Pure Mulberry Silk, Pure Gold Zari',
